<!--- <cfif NOT(session.areamanage EQ 1 or session.cessman contains 1 or session.admin is 1)>
...
u.year2=#session.fy#
and(
<cfif isdefined("usid")>u.userid='#usid#'<cfelse>u.userid='#session.userid#' </cfif>
or
...
<div align="center"><h3>End-of-Year Report for FY #evaluate(session.fy-1)#-#session.fy# - Community Partnership</h3></div>
<hr>

	<cfinclude template="cp_eoy_sub.cfm">
